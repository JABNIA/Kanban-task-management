...
function EditBoard({setInModal, setDropDownOpen}) {
    ...
    if (context.deleteBoardModal === true){
        return <DeleteBoardMenu setInModal={setInModal} context={context}/>
    }else{
        return <BoardEditModal setInModal={setInModal} context={context}/>
}
}
...
function BoardEditModal({setInModal, context}) {
    return (
